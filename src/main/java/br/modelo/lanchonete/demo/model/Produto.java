...
public class Produto {
    ...
    private String status; // Ex: "Normal", "Baixo", "Crítico"
    ...
    public Produto(String nome, String categoria, Integer quantidade, Double precoCusto, Double precoVenda, String descricao, Integer estoqueMinimo, String fornecedor) {
        ...
        this.atualizarStatus(); // Define o status automaticamente ao criar
    }

    // Lógica simples para definir o status baseado na quantidade
